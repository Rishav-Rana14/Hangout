...
const SignUp = () => {
  ...
  console.log("hsgfdhftf",Gander)

  return (
    <div className="container-fluid ">
      <div className="row">

        <div className="col-12 account-part">
              ...
              <div className="row my-3">
                <div className="col-4">
                  <div class="form-check">
                    <input class="form-check-input" value="male" onChange={(e)=>setGander(e.target.value)} type="radio" name="flexRadioDefault" id="flexRadioDefault1" />
                ...
                <div className="col-4">
                  <div class="form-check">
                    <input class="form-check-input " value="Female" onChange={(e)=>setGander(e.target.value)} type="radio" name="flexRadioDefault" id="flexRadioDefault2" />
                ...
                <div className="col-4">
                  <div class="form-check">
                    <input class="form-check-input" value="others" onChange={(e)=>setGander(e.target.value)} type="radio" name="flexRadioDefault" id="flexRadioDefault3" />
